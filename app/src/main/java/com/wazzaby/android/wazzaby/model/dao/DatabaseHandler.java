package com.wazzaby.android.wazzaby.model.dao;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                KEY_EMAIL+" TEXT,"+KEY_IDPROB+" TEXT, "+KEY_LIBELLEPROB+" TEXT);";
   ...
   /* public String getLastProbLibelle() {
    ...
    public void addUSER(Profil profil) {
        ...
        values.put(KEY_LIBELLEPROB, profil.getLibelle_prob());
    ...
    public Profil getUSER(int id) {
        ...
        Cursor cursor = db.query(TABLE_USER, new String[] { KEY_ID,
                        ...
                        KEY_PAYS,KEY_VILLE,KEY_IDPROB,KEY_LIBELLEPROB}, KEY_ID + "=?",
